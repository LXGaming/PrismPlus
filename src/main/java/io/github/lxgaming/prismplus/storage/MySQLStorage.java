...
public class MySQLStorage extends MySQLStorageAdapter {
    ...
    public MySQLStorage() {
        ...
        tablePrefix = Prism.getConfig().getNode("db", "mysql", "tablePrefix").getString();
    }
    ...
    public void purge() {
        ...
        try (Connection connection = getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(sql);) {
            ...
            PrismPlus.getInstance().getLogger().info("Successfully purged Prism MySQL database ({}ms).", stopwatch.stop().elapsed(TimeUnit.MILLISECONDS));
